...
![json.png](http://cdn.safeandsound.cn/image/拓展chrome插件json-viewer/json.png)
...
![效果图](http://cdn.safeandsound.cn/image/拓展chrome插件json-viewer/finish.png)

[本人已修改样式且打包了的拓展程序在此](https://github.com/VanjayDo/JSONView-for-Chrome) 
<br>
**注3：**直接安装crx包可能会在之后因为安全问题被chrome永久禁用，解决办法有二,1.可以开启开发者模式，选择“加载已解压的拓展程序”，从JSONView-for-Chrome-master\WebContent文件夹直接安装源码，<br> ![源码安装](http://cdn.safeandsound.cn/image/拓展chrome插件json-viewer/源码安装.png)
